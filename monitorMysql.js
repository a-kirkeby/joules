...
const webFormats = ['.css', '.js', '.html', '.htm', '.json', '.xml', '.txt', '.md', '.php', '.asp', '.aspx', '.jsp', '.py', '.rb', '.java', '.c', '.cpp', '.cs', '.ts', '.jsx', '.tsx', '.vue', '.svelte', '.go', '.rs', '.swift', '.kt', '.dart', '.pl', '.sh', '.bat', '.ps1', '.psm1', '.psd1', '.ps1xml']
const imageFormats = ['.jpg', '.jpeg', '.png', '.gif', '.bmp', '.tiff', '.tif', '.webp', '.svg', '.ico', '.heif', '.heic', '.raw', '.cr2', '.nef', '.orf', '.sr2', '.arw', '.dng', '.psd'];
...
const getFileFormat = (url, entryType) => {
    ...
    const formats = [...webFormats, ...fileFormats, ...videoFormats, ...imageFormats]
